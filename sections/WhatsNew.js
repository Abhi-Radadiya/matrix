...
const WhatsNew = () => (
    <section className={`${styles.paddings} relative z-10`}>
        <motion.div
            ...
            className={`${styles.innerWidth} mx-auto flex flex-row gap-8 mobile:flex-col`}
        >
            <motion.div variants={fadeIn("right", "tween", 0.2, 1)} className='flex-[0.95] flex justify-center flex-col'>
                <TypingText title='| Whats new?' />
                <TitleText title={<>What's new about Glow Sine?</>} />
                <div className='mt-[48px] flex flex-wrap justify-between gap-[90px] mobile:gap-[10px]'>
